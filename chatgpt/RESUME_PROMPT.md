...
Use this at the start of a fresh ChatGPT session for a project that already has Context Spine files.

```txt
Resume this project using Context Spine.

Do not use chat history as the source of truth. Treat uploaded or checked-in project files as the shared project state.
